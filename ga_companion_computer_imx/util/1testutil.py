...
class TestCompanionComputer(CompanionComputer):
    ...
    def init(self):
        ...
        while True:
             self.DijKstras_Triggerer(self.navigation_map.world_map.tolist())
    ...
    def navigation_stack(self):
        ...
        #11self.navigation_map.map=self.navigation_map.grid(self.navigation_map.convert_rel_obstacle_to_inertial1(self.coordinate_transform.obstacle_vector_inertial.T[:,0:2]))#inertial frame grid 
