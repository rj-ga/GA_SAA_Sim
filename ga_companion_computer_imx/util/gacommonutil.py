...
class CompanionComputer(object):
    def __init__(self, sitlType, sitlport):
        ...
        #Count the number of items in the mission
    ...
    def handle_recieved_message(self, recievedMsg):
        ...
        if recievedMsg.get_type() == "MISSION_COUNT":
            self.mission_count = recievedMsg.count
            return
        ...
        while not self.connected:
            ...
            try:
                ...
                if self.isSITL:
                    ...
                    self.mavConnection = mavutil.mavlink_connection('/dev/ttyACM0',
                                                               baud=921600,
                                                               source_system=1,
                                                               source_component=10)
                    print("Connecting I guess")
