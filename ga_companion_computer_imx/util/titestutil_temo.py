...
#whenever in auto reset all the markers so that planning can be started again.
    ...
    def log_data(self):
        ...
        final_data = "Time," + str(time.time()-self.log_time)+'{}' + roll_pitch_yaw_string + terrain_alt_str + selfpx_and_selfpy_and_selfpz + gps_lat_lon_of_drone +vx_vy_vz+number+'{}' + frontSensorX +'{}' + frontSensorY +'{}' + frontSensorZ +'{}' + radvel+  '\n'
