...
class TestCompanionComputer(CompanionComputer):
    def __init__(self, sitlType, sitlPort):
        ...
        self.nanoRadar = nanoRadar.NanoRadar()
    ...
    def init(self):
        ...
        '''
        Code snippet to start Nano Radar Thread
        '''
        try:
            thr1 = threading.Thread(target=self.nanoRadar.empty_readings)
            thr1.start()
            thr2 = threading.Thread(target=self.nanoRadar.update)
            thr2.start()
        except Exception as e:
            print("Exception while starting Radar", e)
