...
parser.add_argument("--udpport", type=int, required=False, default=14551,
                    help="defines the tcp port at which mavlink is connected")
parser.add_argument("--sensor", help="ti or nano or lidar", type=str, dest="sensor")
...
if (vehicle in vehicles):
    if vehicle == 'GA3':
        ...
        if sensor == 'ti':
            from util.tiTestutil import TestCompanionComputer as CompanionComp
        elif sensor == 'nano':
            from util.nanoTestutil import TestCompanionComputer as CompanionComp
        elif sensor == 'lidar':
            from util.lidarTestutil import TestCompanionComputer as CompanionComp
        elif sensor == 'ti':
            from util.tiTestutil import TestCompanionComputer as CompanionComp
        else:
